...
The files that I coded from scratch, and that were not generated by modules:
...
- Search for all uses of [responsive media techniques]() in the project<br>![search for all uses of responsive media techniques in the project](public/image-1.png)
...
<br>![issue report](public/image-12.png)
...
I have added meaningfull comments to my code by commenting to title the sections of my homepage.
